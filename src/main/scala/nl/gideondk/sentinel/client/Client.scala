...
object Client {
  ...
  def flow[Context, Cmd, Evt](hosts: Source[ConnectionEvent, NotUsed], resolver: Resolver[Evt], shouldReact: Boolean = false, protocol: BidiFlow[Cmd, ByteString, ByteString, Evt, Any])(implicit system: ActorSystem, mat: ActorMaterializer) = {
  ...
  def apply[Cmd, Evt](hosts: Source[ConnectionEvent, NotUsed], resolver: Resolver[Evt], inputOverflowStrategy: OverflowStrategy, shouldReact: Boolean = false, protocol: BidiFlow[Cmd, ByteString, ByteString, Evt, Any])(implicit system: ActorSystem, mat: ActorMaterializer) = {
    val processor = Processor[Cmd, Evt](resolver, Config.producerParallelism)
  ...
  def apply[Cmd, Evt](hosts: List[Host], resolver: Resolver[Evt], inputOverflowStrategy: OverflowStrategy, shouldReact: Boolean = false, protocol: BidiFlow[Cmd, ByteString, ByteString, Evt, Any])(implicit system: ActorSystem, mat: ActorMaterializer) = {
    val processor = Processor[Cmd, Evt](resolver, Config.producerParallelism)
