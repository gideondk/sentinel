...
//                       description: String = "Sentinel Client", workerReconnectTime: FiniteDuration = 2 seconds)(stages: ⇒ PipelineStage[PipelineContext, Cmd, ByteString, Evt, ByteString], lowBytes: Long = 100L, highBytes: Long = 5000L, maxBufferSize: Long = 20000L)(implicit system: ActorSystem) = {
...
//   def randomRouting[Cmd, Evt](serverHost: String, serverPort: Int, numberOfWorkers: Int, description: String = "Sentinel Client", workerReconnectTime: FiniteDuration = 2 seconds)(stages: PipelineStage[PipelineContext, Cmd, ByteString, Evt, ByteString], lowBytes: Long = 100L, highBytes: Long = 5000L, maxBufferSize: Long = 20000L)(implicit system: ActorSystem) =
//     apply[Cmd, Evt](serverHost, serverPort, RandomRouter(numberOfWorkers), description, workerReconnectTime)(stages, lowBytes, highBytes, maxBufferSize)
...
//     apply[Cmd, Evt](serverHost, serverPort, RoundRobinRouter(numberOfWorkers), description, workerReconnectTime)(stages, lowBytes, highBytes, maxBufferSize)
...
//     apply[Cmd, Evt](serverHost, serverPort, RoundRobinRouter(resizer = Some(resizer)), description, workerReconnectTime)(stages, lowBytes, highBytes, maxBufferSize)
//   }
// }
